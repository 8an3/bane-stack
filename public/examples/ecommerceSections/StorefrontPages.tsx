            ...
            <div className="flex h-16 items-center">
                ...
                <div className="flex h-full space-x-8">
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button variant="ghost" className="flex items-center text-sm font-medium text-foreground hover:text-gray-800">
                        Women
                        <ChevronDown className="ml-1 h-5 w-5 flex-shrink-0 text-muted-foreground" />
                      </Button>
                    </DropdownMenuTrigger>
              ...
              <div className="flex flex-1 items-center justify-center px-2 lg:ml-6 lg:justify-end">
                <div className="w-full max-w-lg lg:max-w-xs">
                  <div className="relative">
                    ...
                    <Input
                      className="block w-full rounded-md border-0 bg-background py-1.5 pl-10 pr-3 text-foreground ring-1 ring-inset ring-gray-300 placeholder:text-muted-foreground focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                      placeholder="Search"
                      type="search"
                    />
                  </div>
              ...
              <div className="ml-4 flow-root lg:ml-6">
                <Button variant="ghost" size="icon" className="group -m-2 flex items-center p-2">
                  <ShoppingCart className="h-6 w-6 flex-shrink-0 text-muted-foreground group-hover:text-primary" />
              ...
              <div className="ml-4 flow-root lg:ml-6">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" size="icon" className="group -m-2 flex items-center p-2">
                      <User className="h-6 w-6 flex-shrink-0 text-muted-foreground group-hover:text-primary" />
        ...
        <div className="relative bg-gray-900">
          ...
          <div className="relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40">
            <div className="pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0">
              ...
              <div className="mt-8">
                <Button className="rounded-md bg-background px-3.5 py-2.5 text-sm font-semibold text-foreground shadow-sm hover:bg-background/70 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
                  Shop collection
                </Button>
              </div>
            </div>
        ...
        <section aria-labelledby="trending-heading" className="bg-background">
          <div className="py-16 sm:py-24 lg:mx-auto lg:max-w-7xl lg:px-8 lg:py-32">
            <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-0">
              ...
              <Link to="#" className="hidden text-sm font-semibold text-primary hover:text-primary sm:block">
                See everything
                ...
                <CardContent>
                  <div className="mt-4 flex justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">Black</p>
                    </div>
                    <p className="text-sm font-medium text-foreground">$35</p>
                  </div>
                ...
                <CardContent>
                  <div className="mt-4 flex justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">White</p>
                    </div>
                    <p className="text-sm font-medium text-foreground">$35</p>
                  </div>
                  <div className="mt-4 flex items-center">
                ...
                <CardContent>
                  <div className="mt-4 flex justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">Charcoal</p>
                    </div>
                    <p className="text-sm font-medium text-foreground">$35</p>
                  </div>
                  <div className="mt-4 flex items-center">
                ...
                <CardContent>
                  <div className="mt-4 flex justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">Peach</p>
                    </div>
        ...
        <section aria-labelledby="category-heading" className="bg-background">
          <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
            <div className="sm:flex sm:items-baseline sm:justify-between">
              <h2 id="category-heading" className="text-2xl font-bold tracking-tight text-foreground">
                Shop by Category
              </h2>
              <Link to="#" className="hidden text-sm font-semibold text-primary hover:text-primary sm:block">
            ...
            <div className="mt-6 sm:hidden">
              <Link to="#" className="block text-sm font-semibold text-primary hover:text-primary">
                Browse all categories
                <span aria-hidden="true"> &rarr;</span>
              </Link>
            </div>
          ...
          <div className="relative overflow-hidden rounded-lg">
            ...
            <div className="relative bg-gray-900 bg-opacity-75 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
              <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
                ...
                <Button className="mt-8 rounded-md bg-background px-3.5 py-2.5 text-sm font-semibold text-foreground shadow-sm hover:bg-background/70 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
                  Shop Workspace
                </Button>
              </div>
            </div>
        ...
        <section aria-labelledby="product-heading" className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-x-8">
            ...
            <div className="mt-10 lg:mt-0">
              <h1 id="product-heading" className="text-2xl font-bold tracking-tight text-foreground">
                Basic Tee
              </h1>
              <div className="mt-4 flex items-center">
                ...
                <div className="mt-4">
                  <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
                    <li className="text-muted-foreground">
                      <span className="text-muted-foreground">Hand cut and sewn locally</span>
                    </li>
                    <li className="text-muted-foreground">
                      <span className="text-muted-foreground">Dyed with our proprietary colors</span>
                    </li>
                    <li className="text-muted-foreground">
                      <span className="text-muted-foreground">Pre-washed & pre-shrunk</span>
                    </li>
                    <li className="text-muted-foreground">
                      <span className="text-muted-foreground">Ultra-soft 100% cotton</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <form className="mt-6">
                {/* Colors */}
                <div>
                  <h3 className="text-sm text-foreground">Color</h3>
                  <fieldset className="mt-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 focus:outline-none">
                        ...
                        <span
                          aria-hidden="true"
                          className="h-8 w-8 rounded-full border border-black border-opacity-10 bg-background"
                        />
                      </label>
                    </div>
                  </fieldset>
                ...
                <div className="mt-6">
                  <div className="flex items-center justify-between">
                    <h3 className="text-sm text-foreground">Size</h3>
                    <Link to="#" className="text-sm font-medium text-primary hover:text-primary">
                      Size guide
                    </Link>
                  </div>
                ...
                <div className="mt-6">
                  <div className="flex items-center justify-between">
                    <h3 className="text-sm text-foreground">Quantity</h3>
                  </div>
                ...
                <div className="mt-10 flex">
                  <Button className="flex-1 rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-gray-50">
                    Add to bag
                  </Button>
                  <Button variant="outline" className="ml-4 flex-1 rounded-md border border-border px-8 py-3 text-base font-medium text-foreground hover:bg-background">
                    Save
                  </Button>
                </div>
              </form>
          ...
          <div className="border-t border-border py-20">
            <div className="grid grid-cols-1 md:grid-flow-col md:auto-rows-min md:grid-cols-12 md:gap-x-8 md:gap-y-16">
              ...
              <div className="col-span-6 mt-10 grid grid-cols-2 gap-8 sm:grid-cols-3 md:col-span-8 md:col-start-3 md:row-start-1 md:mt-0 lg:col-span-6 lg:col-start-2">
                ...
                <div>
                  <h3 className="text-sm font-medium text-foreground">Customer Service</h3>
                  <ul role="list" className="mt-6 space-y-6">
                    <li className="text-sm">
                      <Link to="#" className="text-muted-foreground hover:text-muted-foreground">
                        Contact
              ...
              <div className="mt-12 md:col-span-8 md:col-start-3 md:row-start-2 md:mt-0 lg:col-span-4 lg:col-start-9 lg:row-start-1">
                <h3 className="text-sm font-medium text-foreground">Sign up for our newsletter</h3>
                ...
                <form className="mt-2 flex sm:max-w-md">
                  <Input
                    ...
                    className="min-w-0 flex-auto rounded-md border-0 bg-background px-3 py-1.5 text-foreground shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-muted-foreground focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  />
                  <Button
                    type="submit"
                    className="ml-4 flex-none rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  >
                    Subscribe
                  </Button>
                </form>
