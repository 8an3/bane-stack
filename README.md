...
- E-Commerce
  - ProductListsWInlinePrice
  - ProductListsSimple
  - ProductListTallImages
  - ProductListBorderGrid
  - ProductListSupportingText
  - ProductListFullDetails
  - ProductOverviewTieredImages
  - ProductOverviewTabs
  - ProductOverviewGalleryExpandable
  - SettingsScreenSidebar
  - StoreNavImageGrid
  - ShoppingCartExtendedSummary
  - ShoppingCartPage
  - ShoppingCartSingleColumn
  - ShoppingCartTwoColumn
  - ProductQuickviews2
  - ProductQuickviews3
  - ProductQuickviews4
  - OrderSummariesSimple
  - OrderSummariesWSplitImage

- along with whatever else is in needToAdd in components
