    ...
    return (
        <div className={cn(`w-[100%] mx-auto  grid  text-foreground bg-background`)}>
            <div className="w-[95%]  mx-auto  grid gap-3 justify-center">
                <HeroSection className={`text-foreground bg-background`} className2={`text-muted-foreground `} title="Ecommerce - 8an3/Bane" desc="Sections to help build your next project" />
                  <HomeNav />
             <Ecommerce />
            </div>
        </div>
