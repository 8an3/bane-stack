...
export function PageHeaderFunction({
	...
	aLink = "#",
	nav1 = "Blocks",
	nav1To = "/blocks/examples/home/sections",
	nav2 = "Sidebar",
	...
	return (
		<div className="flex  py-[75px]  ">
			<PageHeader>
				...
				<PageActions>
					<NavButton variant="outline" to={nav1To} className="text-muted-foreground">
						{nav1}
					</NavButton>
					<NavButton variant="outline" to={nav2To} className="text-muted-foreground">
						{nav2}
					</NavButton>
					<NavButton variant="outline" to={nav3To} className="text-muted-foreground">
						{nav3}
					</NavButton>
				</PageActions>
			</PageHeader>
