    ...
    return (
      <div className="bg-white border rounded-lg p-4 hover:shadow-lg transition-shadow">
        <div className="flex gap-4">
          <div className="flex-shrink-0 w-24 h-24 bg-gray-100 rounded-lg flex items-center justify-center text-3xl">
            {product.image}
          </div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  <button
                    ...
                    className={`p-2 rounded-full border transition-colors ${
                      isWishlisted ? 'text-red-500 border-red-500' : 'text-gray-400 border-gray-300 hover:text-red-500'
                    }`}
                  >
...
const FilterSidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed lg:static inset-y-0 left-0 w-80 bg-white border-r transform transition-transform z-50 ${
...
const CategoryHeader = ({ title, productCount, viewMode, setViewMode, sortBy, setSortBy, onFilterToggle }) => {
  const sortOptions = [
