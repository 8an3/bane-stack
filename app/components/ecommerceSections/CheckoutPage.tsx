          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-6">
              <Button variant="ghost" size="sm" asChild>
                <Link to="/cart" className="flex items-center text-sm font-medium text-foreground hover:text-foreground">
                ...
                <RadioGroup defaultValue="standard" className="grid gap-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <Label htmlFor="standard" className="flex items-center justify-between w-full">
                      <span>Standard</span>
                      <span className="text-sm font-medium text-foreground">$5.00</span>
                    </Label>
                  </div>
                  <div className="flex items-center space-x-4">
                    ...
                    <Label htmlFor="express" className="flex items-center justify-between w-full">
                      <span>Express</span>
                      <span className="text-sm font-medium text-foreground">$16.00</span>
                    </Label>
                  </div>
                </RadioGroup>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className="h-16 w-16 rounded-md bg-background/70 overflow-hidden">
                        <img
                      ...
                      <div className="ml-4">
                        <h3 className="text-sm font-medium text-foreground">Basic Tee</h3>
                        <p className="text-sm text-muted-foreground">Black</p>
                        <p className="text-sm text-muted-foreground">Large</p>
                      </div>
                    </div>
                    <p className="text-sm font-medium text-foreground">$32.00</p>
                  </div>

                  <div className="flex items-center justify-between border-t border-border pt-4">
                    <dt className="text-sm text-muted-foreground">Subtotal</dt>
                    <dd className="text-sm font-medium text-foreground">$32.00</dd>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <dd className="text-sm font-medium text-foreground">$3.20</dd>
                  </div>
                  <div className="flex items-center justify-between border-t border-border pt-4">
                    <dt className="text-base font-medium text-foreground">Order total</dt>
                    <dd className="text-base font-medium text-foreground">$40.20</dd>
                  </div>
                </div>
              </CardContent>
              <CardFooter className="flex flex-col gap-4">
                <div className="w-full">
                  <h3 className="text-sm font-medium text-foreground mb-2">Payment</h3>
