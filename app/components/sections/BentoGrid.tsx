		...
		<div className="bg-background py-24 sm:py-32">
			<div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
				...
				<div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
					<div className="relative lg:row-span-2">
						...
						<div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
							<div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
								...
								<p className="mt-2 max-w-lg text-sm/6 text-muted-foreground max-lg:text-center">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.</p>
							</div>
					...
					<div className="relative max-lg:row-start-1">
						...
						<div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
							<div className="px-8 pt-8 sm:px-10 sm:pt-10">
								...
								<p className="mt-2 max-w-lg text-sm/6 text-muted-foreground max-lg:text-center">Lorem ipsum, dolor sit amet consectetur adipisicing elit maiores impedit.</p>
							</div>
					...
					<div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
						...
						<div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
							<div className="px-8 pt-8 sm:px-10 sm:pt-10">
								...
								<p className="mt-2 max-w-lg text-sm/6 text-muted-foreground max-lg:text-center">Morbi viverra dui mi arcu sed. Tellus semper adipiscing suspendisse semper morbi.</p>
							</div>
					...
					<div className="relative lg:row-span-2">
						<div className="absolute inset-px rounded-lg bg-background max-lg:rounded-b-4xl lg:rounded-r-4xl" />
						<div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
							<div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
								...
								<p className="mt-2 max-w-lg text-sm/6 text-muted-foreground max-lg:text-center">Sit quis amet rutrum tellus ullamcorper ultricies libero dolor eget sem sodales gravida.</p>
							</div>
								...
								<div className="absolute top-10 right-0 bottom-0 left-10 overflow-hidden rounded-tl-xl bg-gray-900 shadow-2xl outline outline-white/10">
									<div className="flex bg-gray-900 outline outline-white/5">
										<div className="-mb-px flex text-sm/6 font-medium text-muted-foreground">
											<div className="border-r border-b border-r-white/10 border-b-white/20 bg-background/5 px-4 py-2 text-white">NotificationSetting.jsx</div>
...
export function BentoSection2({ heading, subheading, items, className }: BentoSectionProps) {
	return (
		<div className={cn("bg-background py-24 sm:py-32", className)}>
			<div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
				<h2 className="text-center text-base/7 font-semibold text-primary">{subheading}</h2>
				<p className="mx-auto mt-2 max-w-lg text-center text-4xl font-semibold tracking-tight text-balance text-gray-950 sm:text-5xl">{heading}</p>
				<div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
...
function BentoCard({ item }: { item: BentoItem }) {
	...
	return (
		<div className={cn("relative", item.layout === "full" ? "lg:row-span-2" : "", item.position === "left" ? "lg:col-start-1" : "", item.position === "middle" ? "lg:col-start-2" : "", item.position === "right" ? "lg:col-start-3" : "")}>
			<div
				className={cn(
			...
			>
				<div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
					...
					<p className="mt-2 max-w-lg text-sm/6 text-muted-foreground max-lg:text-center">{item.description}</p>
				</div>
				<div className={cn("relative w-full grow", item.layout === "full" ? "min-h-120 max-lg:mx-auto max-lg:max-w-sm" : "", item.hasCodeExample ? "min-h-120" : "flex items-center justify-center")}>
					{item.hasCodeExample ? (
						<div className="absolute top-10 right-0 bottom-0 left-10 overflow-hidden rounded-tl-xl bg-gray-900 shadow-2xl outline outline-white/10">
							<div className="flex bg-gray-900 outline outline-white/5">
								<div className="-mb-px flex text-sm/6 font-medium text-muted-foreground">
						...
						<div className="absolute inset-x-10 top-10 bottom-0 overflow-hidden rounded-t-[12cqw] border-x-[3cqw] border-t-[3cqw] border-gray-700 bg-gray-900 shadow-2xl">
							<img alt="" src={item.imageUrl} className="size-full object-cover object-top" />
						</div>
					) : (
						<img alt="" src={item.imageUrl} className={cn("object-cover", item.layout === "half" ? "w-full max-lg:max-w-xs" : "h-[min(152px,40cqw)]")} />
					)}
				</div>
			</div>
			<div
...
export function BentoDemo() {
	...
	return <BentoSection heading="Everything you need to deploy your app" subheading="Deploy faster" items={bentoItems} />;
}
