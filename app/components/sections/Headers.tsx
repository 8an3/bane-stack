			...
			<nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
										...
										<div className="space-y-2">
											...
											<div className="pl-4 space-y-2">
												{[...products, ...callsToAction].map((item) => (
													<a key={item.name} href={item.href} className="block rounded-lg py-2 px-3 text-sm font-semibold text-gray-900 hover:bg-gray-50">
														{item.name}
													</a>
												))}
											</div>
				...
				<NavigationMenu className="hidden lg:flex">
					<NavigationMenuList className="gap-8">
						<NavigationMenuItem>
							<NavigationMenuTrigger className="text-sm font-semibold text-gray-900 bg-transparent hover:bg-transparent focus:bg-transparent data-[active]:bg-transparent data-[state=open]:bg-transparent">Product</NavigationMenuTrigger>
								...
								<div className="w-screen max-w-md p-4 bg-white rounded-lg shadow-lg">
									...
									<div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50 mt-4 rounded-lg">
										{callsToAction.map((item) => (
											<a key={item.name} href={item.href} className="flex items-center justify-center gap-x-2.5 p-3 text-sm font-semibold text-gray-900 hover:bg-gray-100 first:rounded-l-lg last:rounded-r-lg">
						...
						<NavigationMenuItem>
							<NavigationMenuLink href="#" className="text-sm font-semibold text-gray-900 hover:text-gray-700">
								Features
							</NavigationMenuLink>
						</NavigationMenuItem>
...
export function CenteredHeaderWithEyebrow() {
	return (
