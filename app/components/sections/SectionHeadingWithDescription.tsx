    ...
    <div className="border-b border-border pb-5">
      <div className="sm:flex sm:items-baseline sm:justify-between">
        ...
        <div className="mt-4 flex items-center sm:ml-6 sm:mt-0">
          <Link
            to="#"
            className="inline-flex items-center rounded-md bg-background px-3 py-2 text-sm font-semibold text-foreground shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-background"
          >
            View all
