										...
										<div className="w-full max-w-sm">
											...
											<Form method="post" autoComplete="off">
												...
												<div className="flex flex-col gap-6">
													...
													type="submit" className="bg-[#3b82f6] hover:bg-[#16171a] text-white px-6 py-3 rounded-[0px] transition duration-300 border border-[2px] border-border w-[95%] text-center mx-auto">
													Login
													</ButtonLoading>
												</div>
												</div>
											...
											<div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary  ">
												No account? Once your a client you account will already be set up for you.
											</div>
